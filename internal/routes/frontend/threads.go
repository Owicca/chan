...
func init() {
	infra.S.HandleFunc("/boards/{board_code:[a-z0-9]+}/", ThreadList).Methods(http.MethodGet)
	infra.S.HandleFunc("/boards/{board_code:[a-z0-9]+}/{page:[0-9]+}/", ThreadList).Methods(http.MethodGet)
	infra.S.HandleFunc("/boards/{board_code:[a-z0-9]+}/", ThreadCreate).Methods(http.MethodPost)
}
